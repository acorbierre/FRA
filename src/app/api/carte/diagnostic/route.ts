...
**Total citations :** ${lab.citedByCount ? lab.citedByCount.toLocaleString('fr-FR') : '—'}
**Score d'impact :** ${impactScore ? `${impactScore} citations/publication en moyenne` : '—'}
**Spécialisation Alzheimer :** ${specializationStr} des publications
